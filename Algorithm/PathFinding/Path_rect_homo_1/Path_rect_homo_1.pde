...
for (int ix=N/2-30; ix<N/2+10; ix++){ PosTimesMap[ix][N/2-10] = Float.POSITIVE_INFINITY;  }
myDistMap = new DistMap( starts, PosTimesMap );
myDistMap.TimeMax = 99.0;
}
...
void draw(){
 ...
 PaintGrid(0,0,myDistMap.fromA, myDistMap.TimeMax);
 PaintPosBuff(0,0, myDistMap.lastPos );
