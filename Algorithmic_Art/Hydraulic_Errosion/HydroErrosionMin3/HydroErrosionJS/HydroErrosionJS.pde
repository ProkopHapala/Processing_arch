...
Terrain generation filter using hidraulic errosion. Wide variety of terrain types is possible if parrameters of simulation are changed to generate (including rivers) by this algorithm.

because it use arrays and does not need ordering of height-field it is more efficient than  the code of erik schluntz (which was the inspiration)
http://www.openprocessing.org/sketch/46451
