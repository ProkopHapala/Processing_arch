...
vec3 map( in vec3 pos )
{
	...
	//ipos.x += floor(10.0*sin( time + 0.1*ipos.y));
...
*/
    ...
    vec3 brdf  = 1.0*vec3(0.20,0.05,0.02)*lamb*occ;
         brdf += 1.0*vec3(1.60,0.70,0.30)*lkey*lkat*(0.5+0.5*occ);
         brdf += 1.0*vec3(0.70,0.20,0.08)*lbac*occ;
         brdf *= vec3(1.3,1.1,1.0);
